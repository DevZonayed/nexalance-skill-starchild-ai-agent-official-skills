...
- **⚠️ Footer / source attribution — use standard component (verified 2026)**: ad-hoc footer markup causes inconsistent positioning across slides. Always use this `.slide-footer` pattern for all source citations, page numbers, and disclaimers:
  ```html
  ...
  ```
  Never use in-flow / `position: relative` footers — they shift when slide content height changes.
